...
The dataset is distributed in a single archived record (\slot{record concept
DOI --- minted at publication}), together with this paper and the repository
...
the repository code snapshot --- accompanies this release; its DOI is minted
...
with a persistent DOI \slot{record concept DOI --- minted at publication}
containing: (1) this paper; (2) the dataset package --- the cubes, sidecars,
...
at tag \texttt{v3.0.1} with the complete configuration and pipeline code
