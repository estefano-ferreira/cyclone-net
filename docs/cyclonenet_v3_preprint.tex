...
The dataset is published as an archived dataset record (\slot{dataset concept
DOI --- minted at publication}) under the CC~BY~4.0 license. See
...
Two archived records --- one for the software, one for the dataset --- accompany
...
\texttt{LICENSE} file). This paper is accompanied by two separate archived
records, each with a persistent DOI: (1) the \textbf{software record
v3.0.0} \slot{software record DOI}
...
\textbf{dataset concept record} \slot{dataset concept DOI --- minted at
